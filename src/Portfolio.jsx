...
{ name: "React Native", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" },      { name: "JavaScript", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" },
...
const projects = [
 {
   ...
   {
    title: "Grocery Buddy",
    description: "Add, edit, and delete grocery items, track amounts spent, and manage your list any time.",
  ...
  },
  {
    ...
    description: "A system that tracks all company activities to make work easier.",
    ...
    <>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .pf-cta-btn { background: var(--gold); color: #111; font-weight: 700; border: none; padding: 0.5rem 1.4rem; font-size: 0.9rem; cursor: pointer; letter-spacing: 0.3px; box-shadow: 3px 3px 0 #7a5200; transition: transform 0.15s, box-shadow 0.15s; }
      ...
      <div id="portfolio-root">
        ...
        <nav className="pf-nav">
          <a className="pf-brand" href="#home">My<span>Portfolio</span></a>
          <ul className="pf-nav-links">
            {navLinks.map((link) => (
              <li key={link}>
                <a href={`#${link}`} className={activeNav === link ? "active" : ""} onClick={() => setActiveNav(link)}>
          ...
          <div className="container">
            ...
            <div className="pf-skill-tabs">
              {skillCategories.map((cat) => (
                <button
                  key={cat.label}
                  className={`pf-skill-tab ${activeSkillTab === cat.label ? "active" : ""}`}
                  onClick={() => setActiveSkillTab(cat.label)}
                >
                  {cat.label}
                </button>
              ))}
            ...
            <div className="pf-skills-grid">
              {skillCategories
                .find((cat) => cat.label === activeSkillTab)
                ?.skills.map((s) => (
                  <div className="pf-skill-card" key={s.name}>
                    <div className="pf-skill-icon-wrap">
